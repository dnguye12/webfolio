export const myProjects = [
  ...
  {
    title_en: "Quarantie 51",
    title_fr: "Quarantie 51",
    imageUrl: "/projects/q51.png",
    summary_en: "Tebex E-commerce webstore for Quarantie 51 FiveM Server.",
    summary_fr: "Boutique en ligne Tebex pour Quarantie 51, serveur FiveM.",
    ...
    techStack_en: {
      ...
      hosting: "Deployed on a custom hosting solution with real-time integration to the FiveM server."
    },
    techStack_fr: {
      ...
      hosting: "Déployé sur une solution d'hébergement personnalisée avec intégration en temps réel au serveur FiveM."
    },
    liveUrl: "https://quarantine51.tebex.io/",
    sourceCodeUrl: ""
  },
  {
    id: 5,
  ...
  {
    title_en: "FrontlineRP",
    title_fr: "FrontlineRP",
    imageUrl: "/projects/frontline.png",
    summary_en: "Tebex E-commerce webstore for Frontline RP, one of the biggest UK FiveM Server.",
    summary_fr: "Boutique e-commerce Tebex pour Frontline RP, l’un des plus grands serveurs FiveM du Royaume-Uni.",
    tags: ["HTML", "CSS", "JavaScript"],
    features_en: ["Admin panel to manage website and products", "Login system for players", "Dynamic offers based on purchase history", "Databases to hold information on users and products", "Real-time updates synced with the Minecraft server"],
    features_fr: ["Panneau d'administration pour gérer le site et les produits", "Système de connexion pour les joueurs", "Offres dynamiques basées sur l'historique des achats", "Bases de données pour stocker les informations des utilisateurs et des produits", "Mises à jour en temps réel synchronisées avec le serveur Minecraft"],
    techStack_en: {
    ...
    liveUrl: "https://frontline-rp-shop.tebex.io/",
    sourceCodeUrl: ""
  },
  {
    id: 6,
    ...
    summary_en: "My first ever project. A simple and fun implementation of the 2048 game, showcasing my early programming skills and passion for development",
    summary_fr: "Mon premier projet .Une mise en œuvre simple et amusante du jeu 2048, montrant mes premières compétences en programmation et ma passion pour le développement",
    tags: ["Java"],
