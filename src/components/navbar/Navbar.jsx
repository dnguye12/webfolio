...
const Navbar = ({theme, toggleTheme}) => {
  ...
  return (
    <nav className="fixed bottom-[-8px] left-1/2 z-20 flex h-[58px] w-auto max-w-[94vw] -translate-x-1/2 -translate-y-1/2 items-end rounded-full border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-900 px-2 shadow-lg">
