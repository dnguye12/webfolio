...
const ProjectPage = () => {
    ...
    const seoTitle = `${i18n.language === "fr" ? project.title_fr : project.title_en} | Nguyen Duc Huy`
    const seoDescription = i18n.language === "fr" ? project.summary_fr : project.summary_en
    const seoImage = `${import.meta.env.VITE_BASE_URL}${project.imageUrl}`
